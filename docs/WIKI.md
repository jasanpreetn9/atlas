...
over both apps, wired to live data.
...
- Styling: no component framework. Inline `style=""` on each element, plus CSS
  custom properties and a few hover utility classes in
...
6. [Conventions & recipes](./06-conventions.md): runes, markup/styling rules, security, and how to add things
